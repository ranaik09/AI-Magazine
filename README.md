...
│   └── coding-copilot/     # (Example) Local coding assistant
├── workflows/              # End-to-end automation pipelines
│   └── data-pipeline/      # (Example) ETL pipelines using LLMs for unstructured data
...
​Python 3.10+
​Docker (for infrastructure projects)
​An API key for your preferred LLM provider (OpenAI, Anthropic, Gemini, etc.)
